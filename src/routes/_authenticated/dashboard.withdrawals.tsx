        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            {(["mpesa","emola","bank"] as const).map(o => (
              <button key={o} onClick={()=>setMethod(o)} className={`h-11 rounded-xl text-sm font-medium border ${method===o ? "bg-foreground text-background border-foreground" : "bg-card border-border"}`}>
