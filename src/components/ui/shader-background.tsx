...
const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    const vec4 gridColor = vec4(0.35, 0.05, 0.05, 0.6);
    const float scale = 5.0;
    const vec4 lineColor = vec4(0.55, 0.08, 0.08, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.04, 0.0, 0.0, 1.0);
      vec4 bgColor2 = vec4(0.1, 0.01, 0.01, 1.0);
  ...
  useEffect(() => {
    ...
    const resolutionUniform = gl.getUniformLocation(shaderProgram, 'iResolution');
    const timeUniform = gl.getUniformLocation(shaderProgram, 'iTime');
